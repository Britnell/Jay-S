...
if dev:
                ...
                if no_touches is 1 and data[aix]%2==0:
                    ...
                    for x in range(no_touches):
                        ...
                        if air[0] % 2 is 1 :     # uneven ID = touch
                            ...
                            xval = ( data[aix+2] <<8 ) +data[aix+1]
                            yval = ( data[aix+4] <<8 ) +data[aix+3]
                            air.append( xval / 65535 )   # 'x' = 1
                            air.append( yval / 65535 )   # 'y' = 2
    ...
    print( ' no loop, , releasing device ' )
    try:
    ...
    print( ' attaching kernel again')
    try:
        dev.attach_kernel_driver(interface)
        print('attached.')
    except Exception as err:
        print " attach ERROR: ", err
